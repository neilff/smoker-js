...
export const ON_RECORD_TICK = '@@smoker-js/ON_RECORD_TICK';
export const RESET_RECORDING = '@@smoker-js/RESET_RECORDING';
export const SET_RECORDING_STATE = '@@smoker-js/SET_RECORDING_STATE';
